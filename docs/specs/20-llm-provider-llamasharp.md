...
> Superseded by [spec 45](45-llm-provider-inferrouter.md) and [ADR-011](../adr/011-inferrouter-integration.md) — `LlamaSharpLlmProvider` was replaced by `InferRouterLlmProvider`.
