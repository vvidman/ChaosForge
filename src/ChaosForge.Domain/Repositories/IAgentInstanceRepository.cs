...
/// <summary>
/// Persistence contract for the <see cref="AgentInstance"/> aggregate.
/// </summary>
public interface IAgentInstanceRepository : IRepository<AgentInstance, Guid>
{
    /// <summary>
    /// Returns all agent instances active in the specified project.
    /// </summary>
    ...
    /// <summary>
    /// Returns all agent instances with the specified status.
    /// </summary>
