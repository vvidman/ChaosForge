...
/// <summary>
/// Raised when a work task transitions from one workflow status to another.
/// </summary>
/// <param name="WorkTaskId">The identifier of the work task that changed status.</param>
...
public sealed record WorkTaskStatusChangedEvent(
    ...
    WorkTaskStatus NewStatus) : IDomainEvent;
