...
public record DeleteWorkTaskCommand(Guid WorkTaskId) : IRequest<Result>;
...
internal sealed class DeleteWorkTaskCommandHandler(
    IWorkTaskRepository workTaskRepository,
    IUnitOfWork unitOfWork)
    : IRequestHandler<DeleteWorkTaskCommand, Result>
{
