...
public record CompleteWorkTaskCommand(Guid WorkTaskId) : IRequest<Result>;

internal sealed class CompleteWorkTaskCommandHandler(
    IWorkTaskRepository workTaskRepository,
    IUnitOfWork unitOfWork)
    : IRequestHandler<CompleteWorkTaskCommand, Result>
{
