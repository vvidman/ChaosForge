...
public sealed class MarkAgentFinishedCommandHandlerTests
{
    ...
    public async Task Handle_WhenAgentExists_MarksFinishedAndSavesChanges()
    {
        ...
        agentInstance.Status.Should().Be(AgentInstanceStatus.Finished);
    ...
    public async Task Handle_WhenAgentNotFound_ReturnsFailure()
    {
        ...
        var command = new MarkAgentFinishedCommand(agentInstanceId);
