...
public sealed class AcceptRevisionGateCommandHandlerTests
{
    ...
    public async Task Handle_WhenGateNotFound_ReturnsFailure()
    {
        ...
        var command = new AcceptRevisionGateCommand(gateId);
